        ...
        <Card className="backdrop-blur-xl bg-white/10 border-white/20 text-white shadow-2xl relative overflow-hidden">
          ...
          <CardHeader className="text-center relative z-10">
            <motion.div 
               ...
               className="mx-auto bg-gradient-to-tr from-yellow-400 to-orange-500 p-4 rounded-full w-20 h-20 flex items-center justify-center mb-4 shadow-lg shadow-orange-500/50"
            >
              <Trophy className="w-10 h-10 text-white fill-white" />
            </motion.div>
            <CardTitle className="text-4xl font-bold">{getFeedback()}</CardTitle>
          ...
          <CardContent className="space-y-6 relative z-10">
            <div className="flex justify-center items-end gap-2">
              <span className="text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-teal-400 to-emerald-400">
                {percentage}%
              </span>
            ...
            <div className="grid grid-cols-3 gap-4 text-center">
              <div className="bg-black/20 rounded-xl p-3 border border-white/5">
                <div className="text-sm text-gray-400 uppercase tracking-wider text-[10px]">Total</div>
                <div className="text-2xl font-bold">{score.total}</div>
              </div>
              <div className="bg-green-500/20 rounded-xl p-3 border border-green-500/20">
                <div className="text-sm text-green-300 uppercase tracking-wider text-[10px]">Correct</div>
              ...
              <div className="bg-red-500/20 rounded-xl p-3 border border-red-500/20">
                <div className="text-sm text-red-300 uppercase tracking-wider text-[10px]">Wrong</div>
          ...
          <CardFooter className="flex gap-3 relative z-10">
            <Button 
              className="flex-1 bg-white/10 hover:bg-white/20 border-white/10" variant="outline"
